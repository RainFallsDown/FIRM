...
| `${FIRM_DATA_ROOT:-/path/to/firm_data}/FIRM/Tape` | Tape | 10 | `tape roll in paper box` | 1.0000 | 0.9938 | 1.0000 | `results_tape_sam3_tape_roll_in_paper_box_targetsel_ring_first10/` |
| `${FIRM_DATA_ROOT:-/path/to/firm_data}/FIRM/Manual1` | Manual | 10 | `white paper` | 1.0000 | 0.9586 | 0.9673 | `results_manual1_sam3_white_paper_target_inbox_first10/` |
| `${FIRM_DATA_ROOT:-/path/to/firm_data}/FIRM/Cable&Mouse` | Cable | 10 | `power cable` | 1.0000 | 0.9995 | 1.0000 | `results_cable_mouse_sam3_power_cable_first10/` |
| `${FIRM_DATA_ROOT:-/path/to/firm_data}/FIRM/Manufacturing_Lines_Box/task_id_15_stage_1_2_overall` | Box | 10 | `box` | 1.0000 | 0.9722 | 0.8440 | `results_ml_box_sam3_box_first10/` |
