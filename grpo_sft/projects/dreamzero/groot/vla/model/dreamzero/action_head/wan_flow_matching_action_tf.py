...
class WANPolicyHead(ActionHead):
    ...
    def forward(self, backbone_output: BatchFeature, action_input: BatchFeature) -> BatchFeature:
        ...
        print(f"[DEBUG] Before VAE encode: videos.shape={videos.shape}, target_h={target_h}, target_w={target_w}", flush=True)
        ...
        # Per-sample loss for GRPO (use scalar loss as proxy)
