        ...
        if key == "text":
            ...
            for elem in features:
                ...
                try:
                    ...
                    elif elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.HAIMIANDIAN.value]:
                        processed_item = "A multi-view video shows that a robot " + processed_item.lower() + " The video is split into three views: The top-left view shows the camera view from the robot's head, the top-right view shows the camera view from the right hand, and the bottom-left view shows the camera view from the left hand. The robot " + processed_item.lower()
                    else:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        item = "A multi-view video shows that a robot " + item.lower() + " The video is split into three views: The top-left view shows the camera view from the robot's head, the top-right view shows the camera view from the right hand, and the bottom-left view shows the camera view from the left hand. The robot " + item.lower()
                    else:
                        raise ValueError(f"Embodiment ID {elem['embodiment_id']} not supported.")   
